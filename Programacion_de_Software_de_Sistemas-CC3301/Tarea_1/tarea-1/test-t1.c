...
int main(int argc, char **argv) {
  ...
  if (strcmp(s1, "gatoperro")!=0) {
    fprintf(stderr, "resultado  b1 incorrecto %s\n", s1);
	//exit(1);
  }
  char *s2= insercion("", "gato");
  if (strcmp(s2, "gato")!=0) {
    fprintf(stderr, "resultado  b2 incorrecto %s\n", s2);
	//exit(1);
  }
  char *s3= insercion("perro", "");
  if (strcmp(s3, "perro")!=0) {
    fprintf(stderr, "resultado  b3 incorrecto %s\n", s3);
	//exit(1);
  }
  // Parte c
  ...
  if (strcmp(d+1, "gatoperro")!=0) {
    fprintf(stderr, "resultado c incorrecto %s\n", d);
	//exit(1);
  }
